...
"Mission2": {
   ...
   },
   {
      ...
      id: 'Text1',
      text: '<b>आरोपी ग्रिड</b><br><br>यहाँ सारे आरोपी लाइन अप होंगे। इनमें से एक ही शेप अपराधी का है: बाकी सारे बेकसूर हैं। आपको बेकसूरों को छोड़ना है।',
      align: 'left',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text2',
      text: '<b>टूल्स</b><br><br>स्क्रीन पर दिख रही टूलकिट आपको शक होने पर जाँच में मदद करेगी।<br><br>इस मिशन में आपके पास मदद के लिए 4 टूल्स हैं।<ol><li><b>समान साइड मार्कर </b>टूल पर क्लिक कर देखें कि शेप की समान आकार की भुजाओं कौनसी हैं।</li><li><b>कोण मार्कर </b>क्लिक कर जानें कि शेप के कौनसे कोण न्यून, अधिक, रिफ्लेक्स और समकोण हैं।</li><li><b>समानांतर लाइन </b>टूल पर क्लिक करने से शेप्स में कोई भी समानांतर लाइन होने पर वे हाइलाइट हो जाएंगी।</li><li><b>प्रोट्रैक्टर</b> टूल पर क्लिक कर शेप के कोण मापें।</li></ol>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text3',
      text: '<b>क्लु</b><br><br>हर फीचर में ड्रॉप-डाउन फीचर की मदद से एक विकल्प चुनें और रोबोट के लिए सवाल तैयार करें। फिर <b>पूछें</b> पर क्लिक करें।',
      display: 'none',
      type: 'text'
   },
   {
      rect: ['619px','316px','191px','72px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'left',
      id: 'Text4',
      text: '<b>सवाल और जवाब</b><br><br>आपके सवाल और रोबोट के जवाब यहाँ दिखेंगे',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text5',
      text: '<b>एक्शन बटन्स</b><br><br>केस पर काम करते समय एक्शन बटन आपको विभिन्न कार्य करने में मदद करेंगे.<br><b>छोड़ें</b> बटन क्लिक कर आप उस ज्युडिक को छोड़ सकेंगे जिसका शेप मार्कर आपने चुना है.<br>नया केस पाने के लिए और शेप मार्कर्स का नया सेट पाने के लिए <b>रीप्ले करें</b> बटन क्लिक करें.',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text6',
      text: '<b>टोकन काउंटर</b><br><br>टोकन काउंटर में कुछ टोकन होंगे जो हर नए केस में आपको मिलेंगे।<br><br>ये सीमित संख्या में होंगे। हर बार गलत शेप को जोड़ने पर आप एक टोकन गँवा देंगे। बेस (अंतिम) टोकन गँवा देने पर गेम खत्म हो जाएगा। <br><br>केस के अंत में, स्क्रीन पर बचे टोकन्स के आधार पर अंक दिए जाएँगे।',
      display: 'none',
      type: 'text'
   },
   {
      rect: ['471px','473px','201px','90px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'left',
      id: 'Text7',
      text: '<b>पूर्ण</b><br><br>जब आपको लगता है कि केस सुलझा लिया है, तो <b>पूर्ण </b>पर क्लिक करें.',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text8',
      text: '<b>कुल स्टार्स</b><br><br>बिना कोई टोकन गँवाए (यानी बिना कोई गलती किए) केस सुलझाने पर आपको एक स्टार मिलेगा. ',
      display: 'none',
      type: 'text'
   },
   {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid108", tween: [ "style", "${_Rectangle}", "left", '458px', { fromValue: '509px'}], position: 1500, duration: 0 },
            { id: "eid118", tween: [ "style", "${_Rectangle}", "left", '489px', { fromValue: '458px'}], position: 1750, duration: 0 },
            ...
            { id: "eid75", tween: [ "style", "${_Text3}", "top", '235px', { fromValue: '235px'}], position: 500, duration: 0 },
            { id: "eid44", tween: [ "style", "${_Text3}", "top", '292px', { fromValue: '235px'}], position: 750, duration: 0 },
            ...
            { id: "eid32", tween: [ "style", "${_Rectangle}", "top", '220px', { fromValue: '153px'}], position: 500, duration: 0 },
            { id: "eid51", tween: [ "style", "${_Rectangle}", "top", '305px', { fromValue: '220px'}], position: 750, duration: 0 },
            { id: "eid63", tween: [ "style", "${_Rectangle}", "top", '91px', { fromValue: '305px'}], position: 1000, duration: 0 },
            { id: "eid90", tween: [ "style", "${_Rectangle}", "top", '122px', { fromValue: '101px'}], position: 1250, duration: 0 },
            { id: "eid109", tween: [ "style", "${_Rectangle}", "top", '463px', { fromValue: '132px'}], position: 1500, duration: 0 },
            { id: "eid119", tween: [ "style", "${_Rectangle}", "top", '123px', { fromValue: '463px'}], position: 1750, duration: 0 },
            ...
            { id: "eid26", tween: [ "style", "${_Rectangle}", "height", '175px', { fromValue: '175px'}], position: 0, duration: 0 },
            { id: "eid1", tween: [ "style", "${_Rectangle}", "height", '339px', { fromValue: '175px'}], position: 250, duration: 0 },
            { id: "eid560", tween: [ "style", "${_Rectangle}", "height", '163px', { fromValue: '320px'}], position: 500, duration: 0 },
            { id: "eid53", tween: [ "style", "${_Rectangle}", "height", '122px', { fromValue: '128px'}], position: 750, duration: 0 },
            { id: "eid82", tween: [ "style", "${_Rectangle}", "height", '196px', { fromValue: '73px'}], position: 1000, duration: 0 },
            { id: "eid98", tween: [ "style", "${_Rectangle}", "height", '291px', { fromValue: '94px'}], position: 1250, duration: 0 },
            { id: "eid111", tween: [ "style", "${_Rectangle}", "height", '110px', { fromValue: '307px'}], position: 1500, duration: 0 },
            { id: "eid123", tween: [ "style", "${_Rectangle}", "height", '135px', { fromValue: '80px'}], position: 1750, duration: 0 },
            ...
            { id: "eid110", tween: [ "style", "${_Rectangle}", "width", '227px', { fromValue: '272px'}], position: 1500, duration: 0 },
            { id: "eid562", tween: [ "style", "${_Rectangle}", "width", '226px', { fromValue: '227px'}], position: 1750, duration: 0 },
...
"Mission1": {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text2Copy',
      text: '<b>क्लु</b><br><br>क्लु के सेट की मदद से आप शेप्स का मूल्यांकन कर उन्हें छोड़ सकेंगे। हर क्लु एक गुण है जो अपराधी में है।<br><br>क्यु की मदद से उन शेप्स को छोड़ दें जिनमें वह गुण नहीं है। फिर <b>क्लु</b> पर क्लिक कर नया क्लु पाएँ',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text3Copy',
      text: '<b>टूल्स</b><br><br>स्क्रीन पर दिख रही टूलकिट आपको शक होने पर जाँच में मदद करेगी।<br><br>इस मिशन में आपके पास मदद के लिए 3 टूल्स हैं।<ol><li><b>समान साइड मार्कर</b> टूल पर क्लिक कर देखें कि किस शेप की समान आकार की भुजाओं हैं।</li><li><b>समानांतर लाइन</b> टूल पर क्लिक करने से शेप्स में कोई भी समानांतर लाइन होने पर वे हाइलाइट हो जाएंगी।</li><li><b>समकोण</b> टूल पर क्लिक कर देखें कि शेप्स का कौनसा टूल समकोण है, या उससे बड़ा या छोटा है।</li></ol>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text5Copy',
      text: '<b>एक्शन बटन्स</b><br><br>केस पर काम करते समय एक्शन बटन आपको विभिन्न कार्य करने में मदद करेंगे।<br><br><b>छोड़ें</b> बटन क्लिक कर आप उस ज्युडिक को छोड़ सकेंगे जिसका शेप आपने चुना है।<br><br>नया केस पाने के लिए और शेप मार्कर्स का नया सेट पाने के लिए <b>रीप्ले करें</b> बटन क्लिक करें।',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text6',
      text: '<b>टोकन काउंटर</b><br><br>टोकन काउंटर में कुछ टोकन होंगे जो हर नए केस में आपको मिलेंगे।<br><br>ये सीमित संख्या में होंगे। हर बार गलत शेप को छोड़ने पर आप एक टोकन गँवा देंगे। बेस (अंतिम) टोकन गँवा देने पर गेम खत्म हो जाएगा। <br>केस के अंत में, स्क्रीन पर बचे टोकन्स के आधार पर अंक दिए जाएँगे।',
      display: 'none',
      type: 'text'
   },
   {
   ...
   {
      rect: ['566px','469px','199px','72px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'left',
      id: 'Text8',
      text: '<b>पूर्ण</b><br><br>जब आपको लगता है कि केस सुलझा लिया है, तो <b>पूर्ण</b> पर क्लिक करें.',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid553", tween: [ "style", "${_Rectangle}", "top", '255px', { fromValue: '126px'}], position: 250, duration: 0 },
            { id: "eid32", tween: [ "style", "${_Rectangle}", "top", '151px', { fromValue: '255px'}], position: 500, duration: 0 },
            ...
            { id: "eid119", tween: [ "style", "${_Rectangle}", "top", '458px', { fromValue: '127px'}], position: 1500, duration: 0 },
            { id: "eid551", tween: [ "style", "${_Text2Copy}", "top", '266px', { fromValue: '314px'}], position: 250, duration: 0 },
            ...
            { id: "eid1", tween: [ "style", "${_Rectangle}", "height", '189px', { fromValue: '160px'}], position: 250, duration: 0 },
            { id: "eid250", tween: [ "style", "${_Rectangle}", "height", '270px', { fromValue: '189px'}], position: 500, duration: 0 },
            { id: "eid82", tween: [ "style", "${_Rectangle}", "height", '226px', { fromValue: '270px'}], position: 750, duration: 0 },
            { id: "eid98", tween: [ "style", "${_Rectangle}", "height", '258px', { fromValue: '226px'}], position: 1000, duration: 0 },
            { id: "eid111", tween: [ "style", "${_Rectangle}", "height", '138px', { fromValue: '258px'}], position: 1250, duration: 0 },
            { id: "eid123", tween: [ "style", "${_Rectangle}", "height", '116px', { fromValue: '138px'}], position: 1500, duration: 0 },
...
"Mission3": {
   ...
   },
   {
      ...
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1.00)','normal','none','normal'],
      id: 'Text1Copy',
      text: '<b>अनुमति-प्राप्त सेट</b><br><br>इसके द्वारा उन ज्युडिक्स के शेप मार्कर की पहचान करें जिन्हें श्री जी. की फैक्टरियों में जाने की अनुमति है।',
      align: 'left',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text2Copy',
      text: '<b>ब्लॉक किया गया सेट</b><br><br>इसके द्वारा उन ज्युडिक्स के शेप मार्कर की पहचान करें जिन्हें श्री जी. की फैक्टरियों में जाने की अनुमति नहीं है.',
      display: 'none',
      type: 'text'
   },
   {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text3Copy',
      text: '<b>गुणों का चयन</b><br><br>अनुमति-प्राप्त ज्युडिक्स में कोई गुण बनाने के लिए इसका उपयोग करें. इसके लिए हर फीचर के ड्रॉप-डाउन मेनू का इस्तेमाल करें और <b>बनाएं</b> पर क्लिक करें.<br>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text4Copy',
      text: '<b>बनाएं बटन</b><br><br>किसी ज्युडिक का शेप मार्कर बनाने के लिए <b>बनाएं</b> बटन पर क्लिक करें',
      display: 'none',
      type: 'text'
   },
   {
      rect: ['478px','101px','270px','109px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'left',
      id: 'Text5Copy',
      text: '<b>शेप मार्कर बॉक्स</b><br><br>आपके द्वारा बनाए गए शेप मार्कर्स यहां दिखेंगे।',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text6Copy',
      text: '<b>जासूस भेजें बटन</b><br><br>जानना चाहते हैं कि आपका बनाया शेप मार्कर सही है या नहीं? जानने के लिए <b>जासूस भेजें </b>बटन पर क्लिक करें',
      display: 'none',
      type: 'text'
   },
   {
      rect: ['626px','128px','203px','112px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'left',
      id: 'Text7Copy',
      text: '<b>अमान्य करें बटन</b><br><br>गलत शेप मार्कर बना दिया? उसे हटाकर एक नया शेप बनाने के लिए <b>अमान्य करें</b> बटन पर क्लिक करें',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text8',
      text: '<b>टोकन काउंटर</b><br><br>हर नए केस में आपको टोकन्स मिलेंगे। ये आपको टोकन काउंटर पर दिखेंगे।<br><br>याद रखें:<ol><li>ये सीमित संख्या में होंगे.</li><li>आप टोकन्स गवाँ देंगे यदि<ul><li>आप कोई शेप चुनते हैं जो अनुमत सेट के अनुरूप न हो</li><li>आप कोई गलत सवाल पूछते हैं</li></ul></li><li>बेस, अर्थात अंतिम टोकन गँवा देने पर आप गेम हार जाएंगे।</li></ol>',
      display: 'none',
      type: 'text'
   },
   {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid323", tween: [ "style", "${_Text4Copy}", "top", '387px', { fromValue: '387px'}], position: 1000, duration: 0 },
            { id: "eid322", tween: [ "style", "${_Text4Copy}", "left", '274px', { fromValue: '274px'}], position: 1000, duration: 0 },
            { id: "eid21", tween: [ "transform", "${_pointer}", "scaleY", '0.27', { fromValue: '0.27'}], position: 0, duration: 0 },
            { id: "eid4", tween: [ "transform", "${_pointer}", "scaleY", '0.3', { fromValue: '0.27'}], position: 250, duration: 0 },
            ...
            { id: "eid359", tween: [ "style", "${_Text7Copy}", "left", '554px', { fromValue: '554px'}], position: 1750, duration: 0 },
            ...
            { id: "eid326", tween: [ "style", "${_Text5Copy}", "top", '292px', { fromValue: '292px'}], position: 1250, duration: 0 },
            { id: "eid336", tween: [ "style", "${_Text6Copy}", "width", '242px', { fromValue: '242px'}], position: 1500, duration: 0 },
            { id: "eid335", tween: [ "style", "${_Text6Copy}", "top", '290px', { fromValue: '290px'}], position: 1500, duration: 0 },
            ...
            { id: "eid312", tween: [ "style", "${_Text3Copy}", "top", '300px', { fromValue: '300px'}], position: 750, duration: 0 },
            { id: "eid313", tween: [ "style", "${_Text3Copy}", "top", '292px', { fromValue: '300px'}], position: 1000, duration: 0 },
            ...
            { id: "eid314", tween: [ "style", "${_Text3Copy}", "height", '158px', { fromValue: '158px'}], position: 750, duration: 0 },
            { id: "eid148", tween: [ "style", "${_Text8}", "height", '241px', { fromValue: '241px'}], position: 2000, duration: 0 },
            { id: "eid360", tween: [ "style", "${_Text7Copy}", "top", '484px', { fromValue: '484px'}], position: 1750, duration: 0 },
            ...
            { id: "eid325", tween: [ "style", "${_Text4Copy}", "height", '103px', { fromValue: '103px'}], position: 1000, duration: 0 },
            ...
            { id: "eid32", tween: [ "style", "${_Rectangle}", "top", '290px', { fromValue: '153px'}], position: 750, duration: 0 },
            { id: "eid51", tween: [ "style", "${_Rectangle}", "top", '377px', { fromValue: '290px'}], position: 1000, duration: 0 },
            { id: "eid63", tween: [ "style", "${_Rectangle}", "top", '280px', { fromValue: '377px'}], position: 1250, duration: 0 },
            { id: "eid90", tween: [ "style", "${_Rectangle}", "top", '277px', { fromValue: '280px'}], position: 1500, duration: 0 },
            { id: "eid109", tween: [ "style", "${_Rectangle}", "top", '471px', { fromValue: '277px'}], position: 1750, duration: 0 },
            { id: "eid119", tween: [ "style", "${_Rectangle}", "top", '127px', { fromValue: '471px'}], position: 2000, duration: 0 },
            ...
            { id: "eid361", tween: [ "style", "${_Text7Copy}", "width", '226px', { fromValue: '226px'}], position: 1750, duration: 0 },
            ...
            { id: "eid26", tween: [ "style", "${_Rectangle}", "height", '138px', { fromValue: '138px'}], position: 0, duration: 0 },
            { id: "eid1", tween: [ "style", "${_Rectangle}", "height", '134px', { fromValue: '138px'}], position: 250, duration: 0 },
            { id: "eid401", tween: [ "style", "${_Rectangle}", "height", '280px', { fromValue: '118px'}], position: 500, duration: 0 },
            { id: "eid403", tween: [ "style", "${_Rectangle}", "height", '176px', { fromValue: '300px'}], position: 750, duration: 0 },
            { id: "eid53", tween: [ "style", "${_Rectangle}", "height", '119px', { fromValue: '148px'}], position: 1000, duration: 0 },
            { id: "eid82", tween: [ "style", "${_Rectangle}", "height", '129px', { fromValue: '96px'}], position: 1250, duration: 0 },
            { id: "eid98", tween: [ "style", "${_Rectangle}", "height", '147px', { fromValue: '94px'}], position: 1500, duration: 0 },
            { id: "eid111", tween: [ "style", "${_Rectangle}", "height", '138px', { fromValue: '135px'}], position: 1750, duration: 0 },
            { id: "eid123", tween: [ "style", "${_Rectangle}", "height", '289px', { fromValue: '125px'}], position: 2000, duration: 0 },
            { id: "eid391", tween: [ "style", "${_Rectangle}", "height", '131px', { fromValue: '270px'}], position: 2250, duration: 0 },
            ...
            { id: "eid83", tween: [ "style", "${_Rectangle}", "width", '179px', { fromValue: '256px'}], position: 1250, duration: 0 },
            { id: "eid97", tween: [ "style", "${_Rectangle}", "width", '272px', { fromValue: '179px'}], position: 1500, duration: 0 },
            { id: "eid110", tween: [ "style", "${_Rectangle}", "width", '254px', { fromValue: '272px'}], position: 1750, duration: 0 },
            { id: "eid363", tween: [ "style", "${_Rectangle}", "width", '322px', { fromValue: '254px'}], position: 2000, duration: 0 },
            { id: "eid330", tween: [ "style", "${_Text5Copy}", "width", '169px', { fromValue: '169px'}], position: 1250, duration: 0 },
            ...
            { id: "eid108", tween: [ "style", "${_Rectangle}", "left", '543px', { fromValue: '509px'}], position: 1750, duration: 0 },
            { id: "eid118", tween: [ "style", "${_Rectangle}", "left", '465px', { fromValue: '543px'}], position: 2000, duration: 0 },
...
"Mission4": {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text13Copy',
      text: '<b>टोकन काउंटर</b><br><br>टोकन काउंटर पर आपको हर नए केस के लिए टोकन्स मिलेंगे।<br><br>ये सीमित संख्या में होंगे। आप एक टोकन गवाँ देंगे जब:<ol><li>आप रा-हाका की ग्रिड पर दो कोने खोजने के बाद कोई गलत बिंदु चुनेंगे</li></ol>बेस, अर्थात अंतिम टोकन गँवा देने पर आप गेम हार जाएंगे।<br><br>केस के अंत में, स्क्रीन पर बचे टोकन्स के आधार पर अंक दिए जाएँगे।',
      display: 'none',
      type: 'text'
   },
   {
   ...
   },
   {
      ...
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1.00)','normal','none','normal'],
      id: 'Text1Copy',
      text: '<b>चरण 1</b><br><br>इस चरण में आपको रा-हाका से फ्रेम छिपानी होगी। इसके लिए फ्रेम के बिंदुओं पर क्लिक करें।<br>',
      align: 'left',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text2Copy',
      text: '<b>प्रॉम्प्ट बॉक्स</b><br><br>यहां दिए विवरण के अनुसार <b>ड्रॉइंग ग्रिड</b> पर बिंदु चुनें।',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text3Copy',
      text: '<b>ड्रॉइंग ग्रिड</b><br><br>आप इस ग्रिड में फ्रेम छिपा सकते हैं. <b>प्रॉम्प्ट बॉक्स</b> में दिए विवरण के अनुसार शेप बनाने के लिए बिंदु चुनें।<br>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text4Copy',
      text: '<b>पूर्ण बटन</b><br><br>ग्रिड पर चुने बिंदु अंतिम करने के लिए इसे क्लिक करें।',
      display: 'none',
      type: 'text'
   },
   {
      rect: ['478px','101px','270px','84px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'left',
      id: 'Text5Copy',
      text: '<b>क्लियर बटन</b><br><br>अपने बिंदुओं का चयन बदलने के लिए इसे क्लिक करें।<br>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text6Copy',
      text: '<b>चरण 2</b><br><br>इस चरण में आप और रा-हाका बारी-बारी से एक-दूसरे की फ्रेम खोजने की कोशिश करेंगे।<br>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text7Copy',
      text: '<b>खिलाड़ी का क्षेत्र</b><br><br>आपकी ड्रॉइंग ग्रिड इस क्षेत्र में होती है.<br>',
      display: 'none',
      type: 'text'
   },
   {
      ...
      align: 'left',
      id: 'Text8Copy',
      text: '<b>रा-हाका का क्षेत्र</b><br><br>यहाँ रा-हाका की ग्रिड होती है जिसमें फ्रेम छिपी होती है<br>',
      display: 'none',
      type: 'text'
   },
   {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid460", tween: [ "style", "${_Text4Copy}", "top", '502px', { fromValue: '502px'}], position: 750, duration: 0 },
            ...
            { id: "eid477", tween: [ "style", "${_Text5Copy}", "top", '432px', { fromValue: '432px'}], position: 1000, duration: 0 },
            ...
            { id: "eid501", tween: [ "style", "${_Rectangle}", "width", '357px', { fromValue: '269px'}], position: 1750, duration: 0 },
            { id: "eid536", tween: [ "style", "${_Rectangle}", "width", '332px', { fromValue: '357px'}], position: 2000, duration: 0 },
            ...
            { id: "eid484", tween: [ "style", "${_Text6Copy}", "top", '50px', { fromValue: '50px'}], position: 1250, duration: 0 },
            ...
            { id: "eid51", tween: [ "style", "${_Rectangle}", "top", '489px', { fromValue: '302px'}], position: 750, duration: 0 },
            { id: "eid63", tween: [ "style", "${_Rectangle}", "top", '423px', { fromValue: '489px'}], position: 1000, duration: 0 },
            { id: "eid90", tween: [ "style", "${_Rectangle}", "top", '43px', { fromValue: '423px'}], position: 1250, duration: 0 },
            { id: "eid109", tween: [ "style", "${_Rectangle}", "top", '51px', { fromValue: '43px'}], position: 1500, duration: 0 },
            ...
            { id: "eid26", tween: [ "style", "${_Rectangle}", "height", '141px', { fromValue: '141px'}], position: 0, duration: 0 },
            { id: "eid1", tween: [ "style", "${_Rectangle}", "height", '121px', { fromValue: '141px'}], position: 250, duration: 0 },
            { id: "eid456", tween: [ "style", "${_Rectangle}", "height", '155px', { fromValue: '99px'}], position: 500, duration: 0 },
            { id: "eid53", tween: [ "style", "${_Rectangle}", "height", '125px', { fromValue: '133px'}], position: 750, duration: 0 },
            { id: "eid82", tween: [ "style", "${_Rectangle}", "height", '103px', { fromValue: '93px'}], position: 1000, duration: 0 },
            { id: "eid98", tween: [ "style", "${_Rectangle}", "height", '81px', { fromValue: '94px'}], position: 1250, duration: 0 },
