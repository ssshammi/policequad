...
jQuery('#menu_btn').click(function() {
			alertify.set({ labels: {ok: "Continue",cancel : "Cancel"}  });//,onok:
			alertify.confirm("Are you sure you want to quit the current case and return to the Menu screen?", function(e){ 
			if (e) {
				isBonus =1;
			backgroundSND.stop();
			mainSND.stop();
