...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_btn_XCopy}", "click", function(sym, e) {
   ...
   //Edge symbol: 'btn_next_1'
   (function(symbolName) {   
   
   })("btn_X");
   //Edge symbol end:'btn_X'
   ...
   //Edge symbol end:'Mission3'

   //=========================================================
   
   //Edge symbol: 'Mission3_1'
   (function(symbolName) {   
