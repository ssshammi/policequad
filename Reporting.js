...
"HyperlinksClicked":JSON.stringify(HyperlinksClicked),
"ToolsClicked":JSON.stringify(ToolsClicked),
"NumberOfErrors": "", //infer it from case details values
"NumberOfClues": "",//infer it from case details values

"IncorrectRelease": JSON.stringify(IncorrectRelease), //infer it from case details values
"CorrectRelease": JSON.stringify(CorrectRelease),//infer it from case details values
...
//pass the method to calculate score.
//saveDataStageswindow.opener.saveDataStages(JsonArray);
HyperlinksClicked =[];IncorrectRelease = [];CorrectRelease =[];
ToolsClicked =[];
console.log("JSON Array");
console.log(JsonArray);
}
var IncorrectRelease = [];
var CorrectRelease =[];
