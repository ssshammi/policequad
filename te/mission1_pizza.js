...
var stage4RemoveKeys ="emptysides,lessthan1,atleast1,atleast2empty,morethan1empty,morethan2empty,acute,reflex,parallel".split(',');
...
var stage5RemoveKeys ="emptysides,lessthan1,atleast1,atleast2empty,morethan1empty,morethan2empty,reflex,parallel".split(',');
var M1Stage6 ="exactly1reflexangles,exactly2reflexangles,exactly3reflexangles,exactly5reflexangles,no1reflexangles".split(',');
var stage6RemoveKeys ="emptysides,lessthan1,atleast1,atleast2empty,morethan1empty,morethan2empty,parallel".split(',');
...
var stage9RemoveKeys ="curved,emptysides,lessthan1,atleast1,atleast2empty,morethan1empty,morethan2empty".split(',');
	...
	switch(currentstage){
		case 1:{
			...
			for (var i=0;i<TotalShapes-1;i++){
				 ...
				 XMLNode = finalCluesXML.find('mergedBucket:contains('+allowedClues[i]+')').parent();
		...
		case 9:{
			...
			for (var i=0;i<TotalShapes-1;i++){
				 ...
				 shuffle(shapes);
				 console.log("gfdgfd gd gd"+shapes);
				// setShapesM1.push($j(shapes[0]).prop("tagName"));
				var j =0;
				 // setShapesM1.push($j(shapes[j]).prop("tagName")); 
				 var isNew;
