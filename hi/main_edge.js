...
"tool1": {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text3',
      text: 'Equal Sides Marker Tool',
      rect: ['82px','19px','89px','44px','auto','auto'],
      userClass: 'txt'
   }],
   symbolInstances: [
   ]
...
"tool2": {
   ...
   dom: [
   {
      rect: ['82px','19px','95px','44px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',15,'rgba(255,255,255,1.00)','400','none','normal'],
      userClass: 'txt',
      id: 'Text3',
      text: 'Angle <br>Marker Tool',
      align: 'left',
      type: 'text'
   },
   {
...
"tool3": {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text3Copy',
      text: 'Parallel Lines Tool',
      rect: ['82px','19px','67px','44px','auto','auto'],
      userClass: 'txt'
   }],
   symbolInstances: [
   ]
