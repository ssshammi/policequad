...
jQuery('#menu_btn').click(function() {
			alertify.set({ labels: {ok: "కొనసాగించు",cancel : "రద్ుద చేయండి"}  });//,onok:
			alertify.confirm("ప్రస్తుత కేసు వదిలిపెట్టి మెన్యూ స్క్రీన్ కు మీరు కఛ్ఛితంగా తిరిగి వెళ్ళాలనుకుంటున్నారా?", function(e){ 
			if (e) {
				isBonus =1;
			backgroundSND.stop();
			mainSND.stop();
