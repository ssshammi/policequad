...
"btn_done": {
   ...
   },
   {
      ...
      text: 'पूर्ण<br>',
      align: 'center',
      rect: ['0px','2px','88px','23px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"coinBox": {
   ...
   },
   {
      ...
      text: 'उच्च<br>स्कोर',
      align: 'right',
      rect: ['25px','-33px','37px','40px','auto','auto']
   },
   {
...
"btn_nextcase": {
   ...
   {
      font: ['Tahoma, Geneva, sans-serif',20,'rgba(0,45,26,1.00)','700','none','normal'],
      type: 'text',
      align: 'center',
      id: 'Text7',
      text: 'अगला केस',
      rect: ['0px','22px','85px','54px','auto','auto'],
      userClass: 'txt'
   }],
   symbolInstances: [
   ]
...
"Phase2": {
   ...
   {
      rect: ['34px','57px','162px','30px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',18,'rgba(243,200,70,1.00)','700','none',''],
      id: 'Text',
      text: 'आपका क्षेत्र<br>',
      align: 'center',
      type: 'text'
   },
   {
      rect: ['490px','57px','141px','40px','auto','auto'],
      font: ['Tahoma, Geneva, sans-serif',18,'rgba(255,255,255,1.00)','700','none',''],
      id: 'TextCopy',
      text: 'दुश्मन का क्षेत्र<br>',
      align: 'center',
      type: 'text'
   },
   {
...
"btn_Play": {
   ...
   },
   {
      ...
      text: 'आगे बढो<br>',
      align: 'center',
      rect: ['0px','2px','88px','26px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"inst_txt_1": {
   ...
   },
   {
      ...
      type: 'text',
      id: 'Text6',
      text: 'अब आपकी बारी, दुश्मन की ग्रिड पर बिंदु चुनें.<br>',
      align: 'center',
      rect: ['8px','-1px','989px','41px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"Stage_transition": {
   ...
   {
      rect: ['426px','216px','198px','62px','auto','auto'],
