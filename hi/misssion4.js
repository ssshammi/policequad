  ...
  // console.log("changed");
   $j(".mission").html("मिशन 4");
    ...
    if(level === 0) {
      ...
      gridSize = 5;
		$j(".teleporter1Shape").html("आपका टेलीपोर्टर  <a class='example-image-link' target='_blank' href='images/G_square.png'><b>वर्ग  है</b></a>");
		$j(".oppText").html("दुश्मन का टेलीपोर्टर  <a class='example-image-link' target='_blank' href='images/G_square.png'><b>वर्ग है</b></a>");
     ...
     // teleporter1Shape.style.display = "block";
      ...
      gridSize = 5;
     $j(".teleporter1Shape").html("आपका टेलीपोर्टर <a class='example-image-link' target='_blank' href='images/G_rectangle.png'><b>आयत है</b></a>");
    $j(".oppText").html("दुश्मन का टेलीपोर्टर  <a class='example-image-link' target='_blank' href='images/G_rectangle.png'><b>आयत है</b></a>");
     // teleporter1Shape.style.display = "block";
    } else if(level === 3) {
      legalShapes = squares5.concat(rectangles5);
     ...
     // teleporter1Shape.style.display = "block";
      ...
      computerShape = temp[Math.floor(Math.random()*temp.length)];
      gridSize = 5;
	    $j(".teleporter1Shape").html("आपका टेलीपोर्टर <a class='example-image-link' target='_blank' href='images/G_rhombus.png'><b>समचतुर्भुज है</b></a>");
		$j(".oppText").html("दुश्मन का टेलीपोर्टर  <a class='example-image-link' target='_blank' href='images/G_rhombus.png'><b>समचतुर्भुज है</b></a>");
     ...
     // teleporter1Shape.style.display = "block";
      ...
      computerShape = temp[Math.floor(Math.random()*temp.length)];
      gridSize = 4;
	  	    $j(".teleporter1Shape").html("आपका टेलीपोर्टर <a class='example-image-link' target='_blank' href='images/G_parallelogram.png'><b>समानांतर चतुर्भुज आकार  है</b></a>");
			$j(".oppText").html("दुश्मन का टेलीपोर्टर  <a class='example-image-link' target='_blank' href='images/G_parallelogram.png'><b>समानांतर चतुर्भुज आकार  है</b></a>");
...
/*     p1.style.color="white"; */
  ...
  function selectedPoints(e) { 
    ...
    if (e.currentTarget.children[5].style.display === "block") {
      ...
      for(var i = 0; i < points.length; i++) {
		...
		alertify.alert("आकार के केवल चार कोने का चयन करें।");
	  }
    else {
      e.currentTarget.children[0].style.display = "none";
      e.currentTarget.children[1].style.display = "none";
  ...
  function draw() {
    ...
    if(!valid) {
      alertify.alert("उफ्फ! आकार एक "+ShapeBox[currentLevel]+" होना चाहिए। पुनः प्रयास करें!");
    } else {
...
function getFeedback4(){
	...
	if(MatchedH!="player"){ assessment_negative.play();$j(".mtch_txt").html("आप हार गए"); $j(".job").html("कोई बात नहीं! ");$j(".solved").html("फिर कोशिश करें!");
	$j( ".additionalTextVal").html("नया केस सुलझाएं");
	//$j( ".additionalTextVal").hide();
	}else{ assessment_positive.play();
	 $j(".mtch_txt").html("आप जीत गए"); $j(".job").html("बहुत अच्छे! ");$j(".solved").html("आपने दुश्मन की फ्रेम निष्क्रिय कर दी!");
	 $j( ".additionalTextVal").html("लगता है आपके लिए एक और केस तैयार हे");
	 if(currentLevel == 5){
	  $j( ".additionalTextVal").html("<br>	&ensp;	&ensp;	&ensp;	&ensp;	&ensp;मिशन अंत!");
	 }
	...
	$j(".lvlScreen .level2").html("लेवल "+ (currentLevelDisplay4[currentLevel]+1));
	//alert("ok");
 ...
 // alertify.alert(st +" wins!",getFeedback4);
  ...
  var plot = 'M '+vertices[0][0]*multiplier+' '+vertices[0][1]*multiplier+' L'+vertices[1][0]*multiplier+' '+vertices[1][1]*multiplier+' L'+vertices[2][0]*multiplier+' '+vertices[2][1]*multiplier+' L'+vertices[3][0]*multiplier+' '+vertices[3][1]*multiplier+' ';
	...
	if(st!="player")$j(".nextcase .txt").html("Play Again"); 
		//getFeedback4();
	alertify.alert((st=='player'?"आप जीत गए":"रा-हाका की सेना जीत गई!") ,getFeedback4);	
	//	MatchedH +" wins!"
