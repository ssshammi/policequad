...
function EnableMission2(){
	jQuery(".cont_btn").click(function() {    $j("#gloss_btn,#help_btn,#menu_btn").hide();
		...
		$j(".feedback").hide("slide", function() {
			if(CurrentStage==3){$j('.trans1 .lvlScreen:eq(1)').hide();$j('.trans1 .lvlScreen:eq(0)').show();}
			if(CurrentStage==2){$j('.trans1 .lvlScreen:eq(0)').hide();$j('.trans1 .lvlScreen:eq(1)').show();}
			$j('.trans').show("slide");
		});
		}else{
	...
	var QuestionText = 'అపరాధి ద్గగర ఉందా ' +statment;
...
if (valueObj =="DK"){ countTBD++; return "I Don't Know";}
if (valueObj =="DA"){ countIDK++; return "I don't understand";}
	...
	function WIPAlerts(){
			...
			if( $j(CurrentMission2+'.grid.selected').length ==0){alertify.alert('ద్యచేసి విడుద్ల చేస ంద్ుకు ఒక అమాయక అనుమానిత్ుడు (లు) ని ఎంచుక ండి.');
			 return;
			 }
...
var Hyperlinks= [["parallel",'<a class="example-image-link" target="_blank"  data-lightbox="example-1" href="images/G_parallelSide.png">parallel</a> '],
["acute angles",'<a class="example-image-link" target="_blank" data-lightbox="example-1" href="images/G_acuteAngle.png">acute angles</a> '],
["equal sides",'<a class="example-image-link" target="_blank" data-lightbox="example-1" href="images/G_equalSide.png">equal sides</a> '],
["obtuse angles",'<a class="example-image-link" target="_blank" data-lightbox="example-1" href="images/G_obtuseAngle.png">obtuse angles</a> '],
["straight sides",'<a class="example-image-link" data-lightbox="example-1" href="images/G_straightSide.png">straight sides</a> '],
["curved side",'<a class="example-image-link" target="_blank" data-lightbox="example-1" href="images/G_acuteAngle.png">curved side</a> '],
["right angles",'<a class="example-image-link" target="_blank" data-lightbox="example-1" href="images/G_rightAngle.png">right angles</a> '],
["acute angles",'<a class="example-image-link" target="_blank" data-lightbox="example-1" href="images/G_reflexAngle.png">acute angles</a> ']];