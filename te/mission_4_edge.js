...
"btn_Play": {
   ...
   dom: [
   {
      ...
      id: 'btn_reset_up2',
      type: 'image',
      rect: ['-69px','0px','86px','26px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/btn_reset_up.png','0px','0px']
   },
   {
      userClass: 'img',
      id: 'btn_reset_up2Copy',
      type: 'image',
   ...
   },
   {
      ...
      text: 'పదండి ముందుకు',
      align: 'center',
      rect: ['-69px','1px','155px','26px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"inst_txt_1": {
   ...
   },
   {
      ...
      id: 'Text6',
      text: 'ఇది మీ వంతు,  ప్రత్యర్ధి గ్రిడ్ పై పాయింట్  ఎంపిక చెయ్యండి.',
      align: 'center',
      type: 'text'
   }],
   symbolInstances: [
