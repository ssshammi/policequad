...
"BG07": {
   ...
   },
   {
      ...
      type: 'text',
      id: 'Text6',
      text: 'నేరస్తుని కనుక్కోవడానికి సిస్టమ్ లో ఉన్న క్లూస్  ఉపయోగించండి.  మీకు అది అవసరమైతే కొత్త క్లూ కోసం అడగండి. ప్రతి ఒక్క కొత్త క్లూ ఆధారంగా అమాయకపు జూడిక్స్ ని విడుదల చేయండి.        <br>      <br>కేసుకి వెళ్ళడం కోసం నెక్స్ట్ క్లిక్ చేయండి.',
      align: 'left',
...
"M1_BG04": {
   ...
   },
   {
      ...
      type: 'text',
      id: 'Text',
      text: 'ఏయ్ జియో.  మీ జూడిక్స్ సమస్యలు సృష్టించడం ఎప్పటికీ మానుకోరా? ',
      align: 'center',
      rect: ['218px','56px','188px','61px','auto','auto']
   },
   {
   ...
   },
   {
      ...
      type: 'text',
      id: 'TextCopy3',
      text: 'ఇప్పుడు  ఒక జూడిక్  ఒక పబ్లిక్ గార్డెన్లో చెట్ల నుంచి క్రిస్టల్స్ దొంగిలించాడు. ',
      align: 'center',
      rect: ['591px','233px','237px','55px','auto','auto']
   },
   {
   ...
   {
      rect: ['598px','325px','178px','76px','auto','auto'],
      borderRadius: ['10px','10px','10px','10px'],
      id: 'RoundRectCopy',
      stroke: [0,'rgb(0, 0, 0)','none'],
      type: 'rect',
   ...
   },
   {
      ...
      type: 'text',
      id: 'TextCopy',
      text: 'సాక్ష్యం రిపోర్టుల కోసం సిస్టమ్ చెక్ చేసి పని మొదలుపెట్టు, జియో. ',
      align: 'center',
      rect: ['604px','333px','166px','61px','auto','auto']
   },
   {
   ...
   },
   {
      ...
      text: 'సరే సర్.',
      align: 'center',
      rect: ['685px','571px','92px','29px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"M1_BG06": {
   ...
   {
      rect: ['44px','76px','275px','90px','auto','auto'],
      font: ['Verdana, Geneva, sans-serif',13,'rgba(0,0,0,1)','normal','none','normal'],
      id: 'TextCopy5',
      text: 'జియో, ఇది చాలా కేస్.  ఒక జూడిక్ నిజంగా రక్షిత<br> క్రిస్టల్ పార్క్ పై దాడి చేసాడు. <br>ప్రభుత్వానికి లక్షల విలువగల క్రిస్టల్స్ నష్టం జరిగింది. <br>',
      align: 'center',
      type: 'text'
   },
   {
   ...
   {
      rect: ['434px','153px','194px','74px','auto','auto'],
      borderRadius: ['10px','10px','10px','10px'],
      id: 'RoundRectCopy3',
      stroke: [0,'rgb(0, 0, 0)','none'],
      type: 'rect',
   ...
   {
      rect: ['443px','157px','176px','70px','auto','auto'],
      font: ['Verdana, Geneva, sans-serif',13,'rgba(0,0,0,1)','normal','none','normal'],
      id: 'TextCopy3',
      text: 'నేను అనుమానితులని లాకప్ లో పెట్టాను. మనం దీనిని సాధించాలి జియో. ',
      align: 'center',
      type: 'text'
   },
   {
      rect: ['742px','185px','253px','64px','auto','auto'],
      borderRadius: ['10px','10px','10px','10px'],
      id: 'RoundRectCopy4',
      stroke: [0,'rgb(0, 0, 0)','none'],
      type: 'rect',
   ...
   {
      rect: ['751px','189px','235px','64px','auto','auto'],
      font: ['Verdana, Geneva, sans-serif',13,'rgba(0,0,0,1)','normal','none','normal'],
      id: 'TextCopy4',
      text: 'నేను నా శక్తి కొద్దీ ప్రయత్నం చేస్తాను సర్.  ఇప్పుడే సాక్ష్యులు రిపోర్టులు చూస్తున్నాను.<br>',
      align: 'center',
      type: 'text'
   },
   {
