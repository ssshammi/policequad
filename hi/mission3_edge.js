...
"tool1": {
   ...
   },
   {
      ...
      type: 'text',
      rect: ['82px','17px','78px','59px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"tool2": {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text3Copy2',
      text: 'कोण मार्कर टूल<br>',
      type: 'text',
      rect: ['84px','18px','78px','67px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"tool3": {
   ...
   },
   {
      ...
      align: 'left',
      id: 'Text3Copy',
      text: 'समानांतर लाइन टूल<br>',
      type: 'text',
      rect: ['84px','15px','78px','67px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
...
"btn_ask": {
   ...
   {
      userClass: 'txt',
      font: ['Tahoma, Geneva, sans-serif',16,'rgba(0,45,26,1.00)','700','none',''],
      align: 'center',
      id: 'Text',
      text: 'बनाएं<br>',
      type: 'text',
...
"btn_done": {
   ...
   {
      userClass: 'txt',
      font: ['Tahoma, Geneva, sans-serif',14,'rgba(0,45,26,1.00)','700','none','normal'],
      align: 'center',
      id: 'Text2',
      text: 'जासूस भेजें',
      type: 'text',
      rect: ['7px','51px','78px','28px','auto','auto']
   },
   {
      type: 'image',
      id: 'Arrow012',
...
"coinBox": {
   ...
   {
      rect: ['25px','-33px','37px','33px','auto','auto'],
...
"btn_ask_1": {
   ...
   {
      userClass: 'txt',
      font: ['Tahoma, Geneva, sans-serif',15,'rgba(0,45,26,1.00)','700','none',''],
      align: 'center',
      id: 'Text',
      text: 'अमान्य करें<br>',
      type: 'text',
      rect: ['0px','3px','86px','29px','auto','auto']
   }],
   symbolInstances: [
   ]
   },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid786", tween: [ "style", "${_scanTint2}", "display", 'block', { fromValue: 'block'}], position: 3750, duration: 0 },
            ...
            { id: "eid779", tween: [ "style", "${_Text}", "top", '143px', { fromValue: '143px'}], position: 45, duration: 0 },
            { id: "eid740", tween: [ "style", "${_text_allowed}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid784", tween: [ "style", "${_text_allowed}", "display", 'none', { fromValue: 'none'}], position: 1291, duration: 0 },
            { id: "eid782", tween: [ "style", "${_text_allowed}", "display", 'none', { fromValue: 'none'}], position: 3750, duration: 0 },
            ...
            { id: "eid783", tween: [ "style", "${_text_blocked}", "display", 'none', { fromValue: 'none'}], position: 3750, duration: 0 }         ]
      }
   }
},
"text_allowed": {
   ...
   dom: [
   {
      rect: ['0px','0px','178px','46px','auto','auto'],
      id: 'Rectangle4',
      stroke: [0,'rgb(0, 0, 0)','none'],
      type: 'rect',
   ...
   {
      rect: ['0px','2px','178px','29px','auto','auto'],
