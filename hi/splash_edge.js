...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['208px','304','589px','205px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"policequad_hindi.png",'0px','0px']
         },
         {
            id:'btn_Start',
            type:'rect',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid562", tween: [ "style", "${_policequad_hindi}", "display", 'block', { fromValue: 'none'}], position: 1205, duration: 0 },
            ...
            { id: "eid567", tween: [ "style", "${_logo_ship}", "-moz-transform-origin", [0,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,0]}], position: 250, duration: 0 },
            { id: "eid568", tween: [ "style", "${_logo_ship}", "-ms-transform-origin", [0,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,0]}], position: 250, duration: 0 },
            { id: "eid569", tween: [ "style", "${_logo_ship}", "msTransformOrigin", [0,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,0]}], position: 250, duration: 0 },
            { id: "eid570", tween: [ "style", "${_logo_ship}", "-o-transform-origin", [0,0], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,0]}], position: 250, duration: 0 },
...
"btn_Start": {
   ...
   },
   {
      ...
      font: ['\'Adobe Devanagari\'',25,'rgba(0,0,0,1)','700','none',''],
      id: 'Text',
      text: 'शुरु करते हैं',
      align: 'center',
      type: 'text'
