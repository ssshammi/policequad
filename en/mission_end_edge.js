...
"promotion_m3": {
   ...
   },
   {
      ...
      filter: [0,0,1,1,0,0,0,0,'rgba(0,0,0,0)',0,0,0],
      align: 'center',
      text: 'Special Officer, International Bureau of Investigation (IBI). ',
      textShadow: ['rgba(0,0,0,1.00)',0,1,8],
...
"promotion_m4": {
   ...
   },
   {
      ...
      filter: [0,0,1,1,0,0,0,0,'rgba(0,0,0,0)',0,0,0],
      id: 'Text2Copy2',
      text: 'Chief, International Bureau of Investigation',
      textShadow: ['rgba(0,0,0,1.00)',0,1,8],
      type: 'text'
   }],
   symbolInstances: [
...
"M04": {
   ...
   {
      rect: ['29px','500px','347px','123px','auto','auto'],
      id: 'Rectangle2',
   ...
   {
      rect: ['40px','509px','324px','108px','auto','auto'],
      font: ['Verdana, Geneva, sans-serif',14,'rgba(0,0,0,1)','normal','none','italic'],
      id: 'Text2',
      text: 'It was a tough battle, but Geo and his team finally outwitted Ra-Haka and his army. Earth was Ra-Haka free - at least for now. The difficult times had brought humans and Judics together like never before. At last, Judics could truly call earth their home.',
      align: 'left',
      type: 'text'
   }],
   symbolInstances: [
